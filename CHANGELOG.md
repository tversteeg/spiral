...
## [0.2.2](https://github.com/tversteeg/spiral/compare/v0.2.1...v0.2.2) - 2026-03-12
...
- *(deps)* update swatinem/rust-cache action to v2.9.0
...
- *(deps)* update swatinem/rust-cache action to v2.8.1
